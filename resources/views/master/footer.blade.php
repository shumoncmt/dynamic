          ...
          <div class="widget about-us-widget col-md-3 col-sm-6"><a href="#"><img src="images/header/f-logo2.png" alt=""></a>
            ...
            <ul class="nav">
             <li><a href="https://www.facebook.com/greengenesisbd/"><i class="fa fa-facebook-square"></i></a></li>
              ...
              <li><a href="https://www.linkedin.com/company/green-genesis-engineering-ltd/"><i class="fa fa-linkedin-square"></i></a></li>
              <li><a href="https://www.pinterest.com/GreenGenesisbd48/"><i class="fa fa-pinterest-square"></i></a></li>
            </ul>
          </div>
            ...
            <div class="widget-contact-list row m0">
              <ul>
                <li><i class="fa fa-map-marker"></i>
                  <div class="fleft location_address">House B/113, Mosque Road, New DOHS Mohakhali, Dhaka-1206, Bangladesh</div>
                </li>
                <li><i class="fa fa-phone"></i>
                  <div class="fleft contact_no"><a href="https://greengenesisbd.com/contact-us/">+880 1933 302535</a></div>
                </li>
                <li><i class="fa fa-envelope-o"></i>
                  <div class="fleft contact_mail"><a href="mailto:karim@greengenesisbd.com">karim@greengenesisbd.com</a></div>
                </li>
                <li><i class="icon icon-Timer"></i>
                  <div class="fleft service_time">Sat - Thu : 9am to 7pm</div>
                </li>
              </ul>
            </div>
          </div>
