...
<head>
  ...
  <body>
    <header id="header" class="header-3">
      ...
      <div class="container">
        <div class="row pad-logo logo-wrapper">
          <div class="col-lg-4 col-md-3 col-sm-12 col-xs-12 t-logo"><a href="index-2.html"><img src="images/header/logo-2.png" alt="logo" class="img-responsive"></a></div>
    ...
    <div class="top-navigation">
              ...
              <div class="nav-menu pull-left text-left">
                <div class="nav-t-holder pull-left text-left">
                  ...
                  <div class="nav-t-footer">
                    <ul class="nav">
                      <li class="has-t-submenu active"><a href="index-2.html">Home</a>
                        <ul class="submenu">
      ...
      <!-- Main Navigation-->
      <!-- =========home banner start============-->
      <div id="minimal-bootstrap-carousel" data-ride="carousel" class="carousel slide carousel-fade shop-slider full_width ver_new_2_slider">
        <!-- Wrapper for slides-->
        <div role="listbox" class="carousel-inner">
          <div style="background-image: url(images/slider/homepage2/1.jpg);" class="item active">
            <div class="carousel-caption">
              <div class="thm-container txt-left">
                <div class="box valign-top">
                  <div class="content text-left pull-right">
                    <h1 data-animation="animated fadeInLeft" class="bnrfnt50">Word class best <br> <span class="color2">Manufacturing level</span></h1>
          ...
          <div style="background-image: url(images/slider/homepage2/2.jpg);" class="item">
            <div class="carousel-caption">
              <div class="thm-container">
                <div class="box valign-bottom">
                  <div class="content text-center">
                    <h1 data-animation="animated fadeInUp" class="bnrfnt50">quality <span class="color2">Oil and lubricant</span><br>for your daily life</h1>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <div style="background-image: url(images/slider/homepage2/3.jpg);" class="item">
            <div class="carousel-caption">
              <div class="thm-container txt-left">
                <div class="box valign-top">
                  <div class="content text-left pull-right">
                    <h1 data-animation="animated fadeInLeft" class="bnrfnt50">Industrial solution<br>for <span class="color1">your business</span></h1>
                    <p data-animation="animated fadeInRight" class="pln_he">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do <br>eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut <br>enim ad minim.</p><a data-animation="animated fadeInUp" href="about_us.html" class="view-all hvr-bounce-to-right slide_learn_btn btn">our sevices</a>
                  </div>
                </div>
              </div>
    ...
    <!-- Our Projects-->
    <section class="our-galler-three clearfix">
      <div class="container clearfix">
