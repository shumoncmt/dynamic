    ...
    <section class="breadcumb-wrapper">
      <div class="container clearfix">
        <ul class="breadcumb">
          ...
          <li><span>alternate energy</span></li>
        </ul>
      </div>
    </section>
        ...
        <div class="row">
            ...
            <div class="single-sidebar-widget">
              <div class="special-links">
                <ul>
                  ...
                  <li class="active"><a href="alternate.html">alternate energy</a></li>
                </ul>
              </div>
            </div>
            <div class="single-sidebar-widget">
          ...
          <div class="content-right pull-right tab-content">
            ...
            <div id="meterial" class="tab-pane fade in active">
              <div class="image-box clearfix"><img src="images/services/alternate_energy_01.jpg" alt=""><img src="images/services/alternate_energy_02.jpg" alt="" class="pull-right"></div>
              <div class="sec-title">
                <h2><span>alternate energy</span></h2>
              ...
              <div class="image-caption-box">
                <div class="caption-box-img pad46"><img src="images/services/alternate_energy_03.jpg" alt="Awesome Image"></div>
                <div class="text-box">
