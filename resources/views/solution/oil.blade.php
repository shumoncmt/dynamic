    ...
    <section class="breadcumb-wrapper">
      <div class="container clearfix">
        <ul class="breadcumb">
          ...
          <li><span>Oil and lubricant</span></li>
        </ul>
      </div>
    </section>
        ...
        <div class="row">
            ...
            <div class="single-sidebar-widget">
              <div class="special-links">
                <ul>
                  ...
                  <li class="active"><a href="oil.html">Oil and lubricant</a></li>
          ...
          <div class="content-right pull-right tab-content">
            ...
            <div id="meterial" class="tab-pane fade in active">
              <div class="image-box clearfix"><img src="images/services/Oil_01.jpg" alt=""></div>
              <div class="sec-title">
                <h2><span>Oil and lubricant</span></h2>
              ...
              <div class="image-caption-box">
                <div class="caption-box-img pad46"><img src="images/services/Oil_02.jpg" alt="Awesome Image"></div>
                <div class="text-box">
                  <h2>Storage Tanks</h2>
