    ...
    <section class="breadcumb-wrapper">
      <div class="container clearfix">
        <ul class="breadcumb">
          ...
          <li><span>agricultural processing</span></li>
        </ul>
      </div>
    </section>
      ...
      <div class="container clearfix">
        <div class="row">
            ...
            <div class="single-sidebar-widget">
              <div class="special-links">
                <ul>
                  ...
                  <li class="active"><a href="agricultural.html">agricultural processing</a></li>
          ...
          <div class="content-right pull-right tab-content">
            ...
            <div id="meterial" class="tab-pane fade in active"><img src="images/services/Agricultural_Processing_01.jpg" alt="">
              <div class="sec-title">
                <h2><span>agricultural processing</span></h2>
              ...
              <div class="image-caption-box">
                <div class="caption-box-img pad46"><img src="images/services/Agricultural_Processing_02.jpg" alt="Awesome Image"></div>
                <div class="text-box">
                  <h2>Our Research </h2>
              ...
              <div class="image-caption-box">
                ...
                <div class="caption-box-img"><img src="images/services/Agricultural_Processing_03.jpg" alt="Awesome Image"></div>
              </div>
            </div>
          </div>
        </div>
