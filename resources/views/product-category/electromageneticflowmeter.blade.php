...
<title>Electromagenetic Flow Meter -Best Water Treatment (ETP, STP, WTP, RO) Solutions in Bangladesh</title>
...
<section class="inner-banner2 clearfix">
      <div class="container clearfix">
        <h2>Dynamic Flow Meter</h2>
      </div>
    </section>
    <section class="breadcumb-wrapper">
      <div class="container clearfix">
        <ul class="breadcumb">
          <li><a href="index-2.html">Product</a></li>
          <li><span>Flow Meter</span></li>
        </ul>
      </div>
    </section>
        ...
        <div class="project-post">
          <div class="row">
            <div class="col-sm-4 project-post-info">
              <div class="project-post-image"><a href="projects-details.html"><img src="{{ asset('images/projects/category-demo.jpg') }}" alt=""></a><a href="projects-details.html" class="four_arrow_hover_box"><span class="arrows"><span></span></span></a></div>
        ...
        <div class="project-post">
          <div class="row">
            ...
            <div class="col-sm-4 project-post-info">
              <div class="project-post-image"><a href="projects-details.html"><img src="{{ asset('images/projects/category-demo.jpg') }}" alt=""></a><a href="projects-details.html" class="four_arrow_hover_box"><span class="arrows"><span></span></span></a></div>
              <div class="info-text"><a href="projects-details.html">
                  <h4>Filter Media and Accessories</h4></a>
              </div>
            </div>
            <div class="col-sm-4 project-post-info">
              <div class="project-post-image"><a href="projects-details.html"><img src="{{ asset('images/projects/category-demo.jpg') }}" alt=""></a><a href="projects-details.html" class="four_arrow_hover_box"><span class="arrows"><span></span></span></a></div>
              <div class="info-text"><a href="projects-details.html">
                  <h4>Water Treatment Plants Accessories</h4></a>
